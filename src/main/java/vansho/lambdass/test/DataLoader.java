...
public final class DataLoader {
    ...
    public static final List<Track> trackList;
    public static final List<Album> albumList;

    static{
        Person person1 = new Person("Krist Novoselic", "American");
        Person person2 = new Person("Frances Bean Cobain",  "American");
        Person person3 = new Person("Kurt Cobain", List.of(person2), "American");
        ...
        Person person13 = new Person("Ray Manzarek", List.of(person12), "Jewish");
        Person person14 = new Person("Destiny Jones", "Russian");
        Person person15 = new Person("Nasir Jones", List.of(person14), "Russian");
        Person person16 = new Person("Joseph Adenuga", "African");

        personList = List.of(person1, person2, person3, person4, person5, person6, person7, person8,
        ...
        trackList = List.of(track1, track2, track3, track4, track5, track6, track7, track8, track9, track10,
                ...
                track51, track52, track53, track54, track55, track56);
        ...
        Album album4 = new Album("Illmatic", asList(track36, track37, track38, track39, track40, track41,
                track42, track43, track44, track45), List.of(person15));
